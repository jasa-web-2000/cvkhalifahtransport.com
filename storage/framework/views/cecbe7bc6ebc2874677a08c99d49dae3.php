    ...
    <div class="text-center bg-background-primary px-5 shadow rounded-md">
        ...
        <ul class="max-w-[360px] sm:max-w-[500px] mx-auto mt-8 grid grid-cols-2 sm:grid-cols-3 [&_*]:border-slate-300">
            <?php $__currentLoopData = $partner; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li>
                    <a target="_blank" title="<?php echo e($item[0]); ?>" href="<?php echo e($item[1]); ?>">
                        <div class="border p-4 hover:bg-background-secondary relative">
                            <img loading="lazy"
                                ...
                                src="<?php echo e($item[2]); ?>" title="<?php echo e($item[0]); ?>" alt="<?php echo e($item[0]); ?>">
                        </div>
                    </a>
                </li>
...
<?php /**PATH C:\laragon\www\cvkhalifahtransport.com\resources\views/components/home/partner.blade.php ENDPATH**/ ?>