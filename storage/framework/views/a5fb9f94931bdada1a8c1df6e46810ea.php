<div class="bg-background-primary rounded-lg shadow-md p-5 border-b-8 border-primary">
    ...
    <form method="POST" target="_blank" action="<?php echo e(route('contact.form')); ?>" id="cari-rute"
        ...
        <div class="col-span-full">
            ...
            <select title="Jumlah Penumpang" id="ticket" name="ticket" required autocomplete="off" class="pr-5">
                <?php for($i = 1; $i <= 10; $i++): ?>
                    <option value="<?php echo e($i); ?>"><?php echo e($i); ?> Penumpang</option>
                <?php endfor; ?>
...
<?php /**PATH C:\laragon\www\cvkhalifahtransport.com\resources\views/components/contact/booking.blade.php ENDPATH**/ ?>