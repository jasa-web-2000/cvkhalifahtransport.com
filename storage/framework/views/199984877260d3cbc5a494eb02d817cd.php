...
<div class="bg-white p-5 rounded-lg shadow-lg border-b-8 border-b-primary !text-left">
    <div class="relative">
        <img class="w-full rounded-md aspect-video bg-primary/25 brightness-100 hover:brightness-90" loading="lazy"
            src="<?php echo e($thumbnail); ?>" alt="<?php echo e($title); ?>" title="<?php echo e($title); ?>" width="800" height="450" />
        <span
            class="absolute top-0 left-0 bg-primary text-slate-300 font-semibold p-1 px-2 text-xs rounded-br-lg rounded-tl-lg">
            Unggulan
        </span>
    </div>
    <h3 class="my-4 text-[17px] line-clamp-2" title="<?php echo e($title); ?>">
        <a class="hover:underline no-underline text-text-title-black
        ...
        <div class="">
            <?php $__currentLoopData = $featured; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="flex space-x-2 items-center mb-1.5 line-clamp-1">
                    ...
                    <p class="text-sm"><?php echo e($item['detail']); ?></p>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>

        <p class="mt-4 mb-2 line-clamp-4">
            Segera booking <?php echo e($title); ?> Anda dan percayakan perjalanan Anda kepada kami.
        </p>
        <a class="underline opacity-75" href="<?php echo e($url); ?>" title="<?php echo e($title); ?>">
            Baca selengkapnya...
        </a>
        <div class="w-full mt-4">
            <a href='<?php echo e(whatsapp(null, "Halo admin.\nSaya ingin tanya tentang " . $title . "\n\n" . $url)); ?>'
                title="<?php echo e($title); ?>" class="btn-primary w-full" target="_blank">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
...
<?php /**PATH C:\laragon\www\cvkhalifahtransport.com\resources\views/components/travel/archive/travel-grid.blade.php ENDPATH**/ ?>