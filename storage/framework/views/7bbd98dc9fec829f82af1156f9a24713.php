...
<div class="md:col-span-1 lg:col-span-5 content-start grid grid-cols-1 sm:grid-cols-2 md:grid-cols-1 gap-6">
    <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div
            class="flex gap-x-5 items-start mb-5 <?php echo e(!$loop->first ? 'sm:col-span-1 md:col-span-1' : '!col-span-full'); ?>">
            <div
            ...
            <div class="">
                <h3 class="leading-[100%] mb-2"><?php echo e($item['subSubTitle']); ?></h3>
...
<?php /**PATH C:\laragon\www\cvkhalifahtransport.com\resources\views/components/contact/list.blade.php ENDPATH**/ ?>