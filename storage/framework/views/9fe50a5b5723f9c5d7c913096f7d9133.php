...
<?php $component->withAttributes([]); ?>
    <a target="_blank" href="<?php echo e(whatsapp()); ?>" rel="nofollow noindex" title="Hubungi Kami"
    ...
    <h1 class="mb-5"><?php echo e(web()->title); ?>

        <span class="relative !z-1 whitespace-nowrap">
            <svg aria-hidden="true" viewBox="0 0 418 42" class="fill-primary absolute -bottom-2 w-auto -z-1">
                <path
    ...
    <p class="text-text-description-white"><?php echo e($description); ?></p>
    <div class="my-7 flex-col flex sm:flex-row gap-5 justify-center items-center [&>*]:w-full [&>*]:sm:w-auto">
        <a href="<?php echo e(whatsapp()); ?>" target="_blank" rel="nofollow noindex" title="whatsapp"
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\cvkhalifahtransport.com\resources\views/components/home/hero.blade.php ENDPATH**/ ?>