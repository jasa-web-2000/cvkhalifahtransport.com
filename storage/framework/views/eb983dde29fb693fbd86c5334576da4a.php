...
<div class="my-container">
    <div class="grid grid-cols-1 md:grid-cols-12 gap-y-10 md:gap-x-10 lg:gap-x-20">
        <div class="md:col-span-8 ">
            <img onclick="window.open('<?php echo e(whatsapp()); ?>', '_blank')" src="<?php echo e($thumbnail['url']); ?>"
                class="cursor-pointer rounded-md shadow-md" title="<?php echo e($page); ?>" alt="<?php echo e($thumbnail['alt']); ?>"
                width="<?php echo e($thumbnail['width']); ?>" height="<?php echo e($thumbnail['height']); ?>">
        </div>
        ...
        <div
            ...
            <p>Pesan <strong><?php echo e($page); ?> sekarang juga!</strong></p>

            <div>
                <a target="_blank" href="<?php echo e(whatsapp()); ?>" rel="nofollow noindex" title="Pesan travel"
        ...
        <div class="md:col-span-8" id="detail">
            <p>
                Perjalanan <a href="<?php echo e(url()->current()); ?>"><strong><?php echo e($page); ?></strong></a> selalu menyenangkan
            ...
            <p>
                ...
                Ada banyak penyedia jasa travel dari <?php echo e($originName); ?> ke <?php echo e($destinationName); ?>, namun layanan kami
            ...
            <h2>Informasi Lengkap <?php echo e($page); ?></h2>

            <p>
                Hari ini, tepatnya <?php echo e(\Carbon\Carbon::parse(now())->translatedFormat('l, d F Y')); ?>, kami siap menerima
                pemesanan travel reguler Anda.
                Rute dari <?php echo e($originName); ?> ke <?php echo e($destinationName); ?> maupun sebaliknya akan tetap berangkat, bahkan
            ...
            <p>
                Untuk rute dari <?php echo e($originName); ?> ke <?php echo e($destinationName); ?>, harga tiket mulai dari
                <span
                    class="text-green-700"><?php echo e(Number::currency($productSchema['offers']['lowPrice'], in: 'IDR')); ?></span>
                hingga
                <span
                    class="text-green-700"><?php echo e(Number::currency($productSchema['offers']['highPrice'], in: 'IDR')); ?></span>
                per orang.
            ...
            <p>
                <a href="https://travelterdekat.web.id/travel/dari-<?php echo e(\Illuminate\Support\Str::slug($origin->name)); ?>/ke-<?php echo e(\Illuminate\Support\Str::slug($destination->name)); ?>/<?php echo e($origin->id); ?>/<?php echo e($destination->id); ?>"
                    target="_blank"><?php echo e($page); ?></a>
            ...
            <table>
                <thead>
                    <tr>
                        <th>Dari <?php echo e($originName); ?> Ke <?php echo e($destinationName); ?></th>
                        <th>Dari <?php echo e($destinationName); ?> Ke <?php echo e($originName); ?></th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
            ...
            <p>
                Tersedia 6 sesi keberangkatan setiap hari, baik dari <?php echo e($originName); ?> maupun untuk perjalanan pulang
                dari <?php echo e($destinationName); ?>.
            ...
            <div class="grid grid-cols-1 min-[450px]:grid-cols-2 gap-3 min-[450px]:gap-5 mb-5">
                <?php $__currentLoopData = $gallery; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(whatsapp()); ?>"
                        class=" rounded-lg brightness-90 hover:brightness-100 overflow-hidden">
                        <figure class="relative">

                            <img class="aspect-video object-cover" src="<?php echo e($item[0]); ?>"
                                alt="<?php echo e($item[1]); ?>">
                            <figcaption
            ...
            <p>
                Keamanan dan kenyamanan penumpang dari <?php echo e($originName); ?> ke <?php echo e($destinationName); ?> adalah prioritas
                utama kami.
            ...
            <p>
                Kami adalah agen travel <a href="<?php echo e(route('home')); ?>"><?php echo e(web()->title); ?></a>, penyedia layanan
                <?php echo e($page); ?>

                terbaik dan terpercaya di Sumatra. Dengan pengalaman lebih dari <?php echo e(date('Y') - 2020); ?> tahun, kami siap
            ...
            <p>
                Bagi pecinta travel Sumatra, nama <?php echo e(web()->title); ?> pasti sudah dikenal.
            ...
            <p>Untuk rute ini, kami memiliki partner travel yang berpengalaman, yaitu CV. Idola Tebo Wisata. CV. Idola
                Tebo Wisata sangat rekomendasi untuk rute <a
                    href="https://cvidolatebowisata.com/travel/<?php echo e(\Illuminate\Support\Str::slug($origin->name)); ?>/<?php echo e(\Illuminate\Support\Str::slug($destination->name)); ?>/<?php echo e($origin->id); ?>/<?php echo e($destination->id); ?>"
                    target="_blank"><?php echo e($page); ?></a>.
            </p>

            <h3>Loket Travel <?php echo e(web()->title); ?></h3>
            ...
            <ul>
                <li>Loket utama: <?php echo e(address()->addressLocality); ?></li>
                <?php if($origin->id != 1702020): ?>
                    <li>Loket cabang: <?php echo e(\Illuminate\Support\Str::title($origin->name)); ?></li>
                <?php endif; ?>
                <?php if($destination->id != 1702020): ?>
                    <li>Loket cabang: <?php echo e(\Illuminate\Support\Str::title($destination->name)); ?></li>
                <?php endif; ?>
            ...
            <p>
                ...
                Cukup hubungi admin kami melalui WhatsApp di <a target="_blank" rel="nofollow noopener noreferrer"
                    href="tel:<?php echo e(phoneNumber(null, true)); ?>"><?php echo e(phoneNumber()); ?></a>
                dan tiket travel Anda akan segera diproses dengan cepat dan aman.
            </p>


            <h3>Layanan Unggulan <?php echo e(web()->title); ?></h3>
            ...
            <p>
                Selain rute <?php echo e($page); ?>, kami juga menyediakan berbagai pilihan <a
                    href="<?php echo e(route('travel.archive')); ?>">Travel Sumatra</a> lainnya,
            ...
            <ul>
                <?php $__currentLoopData = $recomendation; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($loop->index < 6): ?>
                        <li>
                            <a
                                href="<?php echo e(route('travel.show', [
                                    'originName' => \Illuminate\Support\Str::slug($originName),
                                    'destinationName' => \Illuminate\Support\Str::slug($item->name),
                                    'originId' => $origin->id,
                                    'destinationId' => $item->id,
                                ])); ?>">
                                Travel <?php echo e($originName); ?> <?php echo e(\Illuminate\Support\Str::title($item->name)); ?>
                    ...
                    <?php else: ?>
                        <li>
                            <a
                                ...
                                Travel <?php echo e($destinationName); ?> <?php echo e(\Illuminate\Support\Str::title($item->name)); ?>
                ...
                <li>
                    <a
                        ...
                        Travel <?php echo e($destinationName); ?> <?php echo e($originName); ?>
            ...
            <h2>Keuntungan Menggunakan <?php echo e($page); ?></h2>
            ...
            <p>
                Kami menyediakan rute travel lengkap di seluruh Sumatra, termasuk perjalanan dari <?php echo e($originName); ?>

                ke <?php echo e($destinationName); ?> maupun sebaliknya.
            ...
            <p>
                Kenyamanan penumpang menjadi prioritas kami selama perjalanan dari <?php echo e($originName); ?> ke
                <?php echo e($destinationName); ?>.
            ...
            <p>
                ...
                <span title="rating 5 / 5" class="rating text-xl"
                    style="background: linear-gradient(to right, var(--primary) 0%, var(--primary) <?php echo e(5 * 20); ?>%, rgba(163,163,163.10) <?php echo e(5 * 20); ?>%, rgba(163,163,163.10) 100%);
            ...
            <?php $__currentLoopData = $testimonial; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="bg-background-primary rounded-md shadow-md p-5 mb-7 ">
                    <blockquote class="border-l-4 border-primary">
                        <p class="italic ml-5"><?php echo e($item[1]); ?></p>
                    </blockquote>
                    <p class="!mb-0">Dari: <span class="font-semibold"><?php echo e($item[0]); ?></span></p>
                    <span>
                        Rating: <?php echo e(5); ?> / 5<span title="rating <?php echo e(5); ?> / 5"
            ...
            <h2>Cara Memesan <?php echo e($page); ?></h2>

            <p>
                Memesan tiket travel dari <?php echo e($originName); ?> kini lebih mudah dan praktis. Kami selalu memberikan
            ...
            <ul>
                <li>Hubungi WhatsApp kami di <?php echo e(phoneNumber()); ?> atau kunjungi garasi di <?php echo e($originName); ?></li>
            ...
            <p>
                Jadi tunggu apa lagi? <?php echo e(web()->title); ?> siap mendukung perjalanan travel Anda ke
                <?php echo e($destinationName); ?> kapan saja dan di mana saja di seluruh Pulau Sumatra.
                Pesan tiket <strong><?php echo e($page); ?></strong> Anda sekarang juga dan nikmati perjalanan yang nyaman
                serta aman!
            </p>
...
<?php /**PATH C:\laragon\www\cvkhalifahtransport.com\resources\views/components/travel/single/index.blade.php ENDPATH**/ ?>